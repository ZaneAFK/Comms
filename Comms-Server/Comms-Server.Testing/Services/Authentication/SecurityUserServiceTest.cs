...
{
	public class SecurityUserServiceTest : TransactionalTest
	{
		public required SecurityUserService SecurityUserService;
		...
		public override async Task Setup()
		{
			...
			SecurityUserService = (SecurityUserService)_provider.GetRequiredService<ISecurityUserService>();
		}
		...
		{
			// Act
			var result = await SecurityUserService.RegisterSecurityUserAsync("TestUser", "testuser@hotmail.com", "supersecure123!");
		...
		[Test]
		public async Task TestRegisterSecurityUserAsync_AuthManagerFails_SucceededIsFalseAndReturnsNullSecurityUser()
		{
			// Arrange
			...
			var failingSecurityUserService = new SecurityUserService(Factory, mockAuthManager.Object);

			// Act
			var result = await failingSecurityUserService.RegisterSecurityUserAsync("TestUser", "testuser@hotmail.com", "supersecure123!");
		...
		[Test]
		public async Task TestRegisterSecurityUserAsync_ExistingSecurityUserWithEmail_SucceededIsFalseAndReturnsNullSecurityUser()
		{
			// Arrange
			var firstResult = await SecurityUserService.RegisterSecurityUserAsync("TestUser", "testuser@hotmail.com", "supersecure123!");
			Assert.IsTrue(firstResult.Succeeded, "Precondition: First registration should succeed");

			// Act
			var result = await SecurityUserService.RegisterSecurityUserAsync("AnotherUser", "testuser@hotmail.com", "anotherpassword");
